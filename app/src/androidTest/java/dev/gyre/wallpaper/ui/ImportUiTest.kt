...
import dev.gyre.wallpaper.data.TestPacks
 ...
 * imported through [dev.gyre.wallpaper.data.ImportSource] — the seam the picker stops at — and the
 * test is about what the collection then shows.
 */
@RunWith(AndroidJUnit4::class)
class ImportUiTest {
    private val application: GyreApplication
