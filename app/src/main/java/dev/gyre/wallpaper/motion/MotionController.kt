...
import dev.gyre.wallpaper.render.MotionSample
...
internal class MotionController(private val context: Context) : SensorEventListener {
    ...
    private var settings = GyreSettings()
    ...
    @Synchronized
    fun start(currentSettings: GyreSettings) {
    ...
    @Synchronized
    fun updateSettings(currentSettings: GyreSettings) {
