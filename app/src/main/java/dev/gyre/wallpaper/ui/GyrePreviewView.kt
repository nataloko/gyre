...
class GyrePreviewView(context: Context) : TextureView(context), TextureView.SurfaceTextureListener {
    private val application = context.applicationContext as GyreApplication
