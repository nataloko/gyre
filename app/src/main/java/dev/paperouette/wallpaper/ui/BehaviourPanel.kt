...
fun BehaviourPanel(
    ...
    darkMode: Boolean,
    onUpdate: ((PaperouetteSettings) -> PaperouetteSettings) -> Unit,
    ...
    Box(
        ...
        LazyColumn(
            ...
            item("motion_label") { PaperouetteSectionLabel("Motion") }
            item("still") {
                PaperouetteToggleRow(
                    title = "Hold still",
            ...
            item("response_label") { PaperouetteSectionLabel("How hard it reacts") }
            item("touch_strength") {
            ...
            item("home_label") { PaperouetteSectionLabel("Home screen") }
            item("launcher_zoom") {
                PaperouetteToggleRow(
            ...
            item("artwork_label") { PaperouetteSectionLabel("Artwork") }
            item("automatic_dark") {
                PaperouetteToggleRow(
            ...
            item("power_label") { PaperouetteSectionLabel("Power") }
            item("battery") {
                PaperouetteToggleRow(
            ...
            item("gestures_label") { PaperouetteSectionLabel("Gestures") }
            item("gestures") {
                Column(
                    Modifier
                        .fillMaxWidth()
                    ...
                    PaperouetteBodyText("Drag — pan the artwork, which drifts on after you let go")
                    PaperouetteBodyText("Two fingers — the next variant of this piece")
                    PaperouetteBodyText("Three fingers — the next piece")
                    Spacer(Modifier.height(2.dp))
                    PaperouetteBodyText("These work on the stage and on the home screen alike.")
                }
            }
...
private fun VersionLine() {
    Text(
        "Paperouette ${BuildConfig.VERSION_NAME}",
        modifier = Modifier
            .fillMaxWidth()
            .padding(top = 28.dp)
            .testTag("version"),
